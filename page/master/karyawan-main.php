...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid kontent">
      <div class="row">
        <div class="col-md-12">
          <h2 class="judul">Karyawan</h2>
          <h6 class="breadcumb-sub">Master / <a href="">Karyawan</a></h6>
        </div>
        <div class="col-md-8">
          <a href="karyawan-tambah.php">
        ...
        <div class="col-md-4">
          <div class="input-group">
            ...
            <input
              type="text"
              class="form-control"
              placeholder="Tulis untuk mencari karyawan"
            />
          </div>
        </div>
      </div>
          ...
          <table class="table table-hover shadow-sm">
            <thead>
              <tr class="bg-dark" style="color: #fff">
                ...
                <th scope="col" width="170">Nama Karyawan</th>
      ...
      <div class="row">
        <div class="col-md-8">
          <button type="button" class="btn btn-primary">
            Karyawan ditampilkan <span class="badge badge-light"><?php echo banyakKaryawan() ?> dari <?php echo banyakKaryawan() ?></span>
