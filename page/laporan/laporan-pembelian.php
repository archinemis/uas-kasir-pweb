...
<html lang="en">
  ...
  <body>
      ...
      <li class="side-link">
        ...
        <?php
          if ($data[5]) {
            ...
            <li class="side-link">
              <a href="../laporan/laporan-pembelian.php" class="dashboard-link" style="color:#fff;">
    ...
    <div class="container-fluid kontent">
      <div class="row">
        <div class="col-md-12">
          <h2 class="judul">Laporan Pembelian</h2>
          <h6 class="breadcumb-sub">Laporan / <a href="">Pembelian</a></h6>
        </div>
        <div class="col-md-7">
          ...
          <table class="table table-hover shadow-sm">
            <thead>
              <tr class="bg-dark" style="color: #fff">
                ...
                <th scope="col" width="200">Kode</th>
                <th scope="col" width="200">Nama Supplier</th>
